...
public class BanlogCommand extends Command {
    ...
    public BanlogCommand(final ServerCore serverCore) {
        super("banlog");
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String s, @NotNull String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            final CustomWindow formWindowCustom = new CustomWindow("§7» §8Banlog");
                ...
                this.serverCore.getTinyRabbit().sendAndReceive((delivery -> {
                    switch (GuardianCalls.valueOf(delivery.getKey().toUpperCase())) {
                        ...
                        case CALLBACK_BAN_BEHAVIOR_ENTRIES_RECEIVED -> {
                            ...
                            final SimpleWindow form = new SimpleWindow.Builder("§7» §8Banlog", content.toString()).build();
                            form.send(e);
                        }
                    }
