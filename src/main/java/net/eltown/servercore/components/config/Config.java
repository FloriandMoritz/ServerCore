package net.eltown.servercore.components.config;
...
public class Config {
    ...
    public static void saveResource(String filename, JavaPlugin instance) {
        saveResource(filename, filename, false, instance);
    }

    public static void saveResource(String filename, String outputName, boolean replace, JavaPlugin instance) {
