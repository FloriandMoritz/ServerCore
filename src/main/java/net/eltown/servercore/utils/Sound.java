package net.eltown.servercore.utils;
...
public enum Sound {
    ...
    public void playSound(final Player player) {
        player.playSound(player.getLocation(), this.value, 1, 1);
    }

    public void playSound(final Player player, final float v, final float v1) {
        player.playSound(player.getLocation(), this.value, v, v1);
    }

    public void playSound(final World world, final Location location) {
        world.playSound(location, this.value, 1, 1);
    }

    public void playSound(final World world, final Location location, final float v, final float v1) {
        world.playSound(location, this.value, v, v1);
    }
